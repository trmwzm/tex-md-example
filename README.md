...
<p align="center"><img src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/d27ecd9d6334c7a020001926c8000801.svg?invert_in_darkmode" align=middle width=160.198995pt height=31.014225pt/></p>
...
replaces anything enclosed between dollar signs with rendered <img alt="$\text{\LaTeX}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width="42.187035pt" height="22.46574pt"/>.
...
this formula <img alt="$\frac{dy}{dx}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/24a7d013bfb0af0838f476055fc6e1ef.svg?invert_in_darkmode" align=middle width="14.29758pt" height="30.648420000000016pt"/> is preprocessed so that it lines up at the correct baseline for the text.
...
and `dvisvgm` on your `PATH`. In addition, you'll need to pre-install the `geometry` package in <img alt="$\text{\LaTeX}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width="42.187035pt" height="22.46574pt"/>.
...
<p align="center"><img alt="$$&#10;\frac{n!}{k!(n-k)!} = {n \choose k}&#10;$$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/32737e0a8d5a4cf32ba3ab1b74902ab7.svg?invert_in_darkmode" align=middle width="127.984725pt" height="39.45249pt"/></p>
...
> It is well known that if <img alt="$ax^2 + bx + c =0$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/162f63774d8a882cc15ae1301cfd8ac0.svg?invert_in_darkmode" align=middle width="119.34153pt" height="26.76201000000001pt"/>, then <img alt="$x = \frac{-b \pm \sqrt{b^2- 4ac}}{2a}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/584fa2612b78129d140fb208e9d76ae9.svg?invert_in_darkmode" align=middle width="112.44139499999999pt" height="33.20525999999999pt"/>.
...
Sometimes, you might run into formulas that are bottom-heavy, like <img alt="$x^2\sum\limits_{3^{n^{n^{n}}}}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/4cb4ead947a07837121937c807973436.svg?invert_in_darkmode" align=middle width="47.78004pt" height="37.03193999999998pt"/>. Here, `readme2tex`
...
* `--usepackage tikz` Addition packages to use during <img alt="$\text{\LaTeX}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width="42.187035pt" height="22.46574pt"/> compilation. You can specify this multiple times.
...
* `--rerender` Ticking this will force a recompilation of all <img alt="$\text{\LaTeX}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/c068b57af6b6fa949824f73dcb828783.svg?invert_in_darkmode" align=middle width="42.187035pt" height="22.46574pt"/> formulas even if they are already cached.
...
like <img alt="$\frac{~}{\sum\limits_{x^{x^{x^{x}}}}^{x^{x^{x^{x}}}} f(x)}$" src="https://github.jpl.nasa.gov/trm/uavsar_notes/master/tex/bdd0f9b91b7fff7fe5a2b1b7684a96ef.svg?invert_in_darkmode" align=middle width="56.16665999999999pt" height="71.68952999999999pt"/>, you'll notice that there might be a lot
